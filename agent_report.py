...
def search_and_record(target_dic, token, api_key, defender_dc, insight_dc):
    for item in target_dic:
        ...
        if str(item["ENV_ID"]) != "n/a":
            ...
            #Get list of EC2 assets running in the AWS account
...
if __name__ == '__main__':
    ...
    if "-a" in myargs:
        ...
        print ("Argument -a is required for the Defender API Key")
        sys.exit()
    ...
    search_and_record(MASTER_DIC, TOKEN, API_KEY, ALERT_LOGIC_CD_DC, ALERT_LOGIC_CI_DC)
